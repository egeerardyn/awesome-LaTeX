...
- [SwiftLaTeX](https://github.com/SwiftLaTeX/SwiftLaTeX) - pdfTeX and XeTeX compiled to WebAssembly, so you can compile LaTeX entirely in the browser or embed a TeX engine in a webpage. ![foss]
...
- [Gummi](https://github.com/alexandervdm/gummi) - Simple GTK LaTeX editor with a continuously updating live preview pane. ![linux] ![foss]
...
- [Murfy](https://www.murfy.ai/en) - Online LaTeX editor with real-time collaboration and built-in AI assistance for writing and error fixing.
...
- [TeXLive.net](https://texlive.net/) - Public compile service (used by LearnLaTeX.org) that turns an HTTP POST of a LaTeX document into a PDF. ![foss]
- [LaTeX.Online](https://latexonline.cc/) - Cloud compiler that builds a PDF from a Git repository, a URL, or pasted TeX; also available as a self-hosted Docker image. ![foss]
...
- [Kroki](https://kroki.io) - Unified HTTP API that renders text-based diagrams, including PGF/TikZ, to SVG, PNG, or PDF. Self-hostable. ![foss]
